...
const btn = document.getElementById('aximo-submit-btn');
...
document.getElementById('form').addEventListener('submit', function(event) {
    ...
    const templateID = 'template_xc59s3d'; // Your EmailJS template ID
    ...
    emailjs.sendForm(serviceID, templateID, this)
        .then(() => {
            ...
            btn.value = 'Send Email'; // Reset the button text in case of an error
